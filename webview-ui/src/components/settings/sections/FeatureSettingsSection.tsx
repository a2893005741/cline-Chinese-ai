...
const agentFeatures: FeatureToggle[] = [
	{
		id: "subagents",
		label: "子代理",
		description: "让 Cline 并行运行专注的子代理，为您探索代码库。",
...
const editorFeatures: FeatureToggle[] = [
	{
		...
		label: "功能提示",
		description: "在思考阶段显示轮播提示，帮助您发现 Cline 功能。",
	...
	},
	{
		id: "worktrees",
		label: "工作树",
		description: "启用 Git 工作树管理，用于并行运行 Cline 任务。",
...
const experimentalFeatures: FeatureToggle[] = [
	...
	},
	{
		id: "lazy-teammate",
		label: "懒惰队友模式",
		description: "有时候 Cline 今天就是不在状态。仅供娱乐。",
