...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: '在设置中启用"完成前双重检查"，让 Cline 在完成任务前验证其工作成果。',
	},
	{
		text: "在项目根目录添加 .clinerules 文件，为 Cline 提供项目专属指令。",
	},
	{
		text: "切换到计划模式，在 Cline 执行操作前先讨论和规划方案。",
	},
	{
		text: "在聊天输入框中使用 @ 添加文件、文件夹或 URL 作为任务上下文。",
	},
	{
		text: "配置 MCP 服务器，让 Cline 访问外部工具和 API。",
	},
	{
		text: "Cline 在每次更改后创建检查点——你随时可以恢复到之前的状态。",
	},
	{
	...
	{
		text: "使用引用按钮选取 Cline 回复中的文本，并在你的回复中引用它。",
	},
	{
		text: "你可以将图片拖放到聊天框中，与 Cline 分享截图。",
	},
	{
		text: "Cline 可以浏览网页——让它在浏览器中测试你的本地开发服务器。",
	},
	{
		text: "使用 /reportbug 快速提交包含诊断信息的 GitHub Issue。",
	},
	{
